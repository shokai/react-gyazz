...
describe 'validator', ->
  ...
  it 'should have method "isEmptyPageText"', ->
    assert.equal typeof validator.isEmptyPageText, 'function'

  describe 'method "isEmptyPageText"', ->
    it 'should return false if not text', ->
      assert.equal validator.isEmptyPageText(null), false

    it 'should return true if page is empty', ->
      assert.equal validator.isEmptyPageText(''), true
      assert.equal validator.isEmptyPageText('(empty)'), true
      assert.equal validator.isEmptyPageText('  \n   '), true

  it 'should have method "removeEmptyLines"', ->
    assert.equal typeof validator.removeEmptyLines, 'function'

  describe 'method "removeEmptyLines"', ->
    it 'should remove empty lines', ->
      assert.deepEqual validator.removeEmptyLines(['', 'hello    ',' ','  world', ' ']), ['hello','  world']
